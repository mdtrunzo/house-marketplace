...
function CreateListing() {
    ...
    const onSubmit = async (e) => {
        ...
        if(geolocationEnabled) {
            const response = await fetch(`https://geocode-address-to-location.p.rapidapi.com/v1/geocode/search?text=${address}&limit=1&lang=en`, {
	            "method": "GET",
	            "headers": {
            ...
            if(data.features.length >= 1){
                ...
                location = (`${data.features[0].properties.address_line1}. ${data.features[0].properties.address_line2}`) ?? 0
            }else{
                setLoading(false)
